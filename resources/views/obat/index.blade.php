                ...
                <div
                    ...
                    <div class="mb-4 flex justify-center">
                        <a href="{{ route('obat.create') }}"
                            class="mb-6 w-32 px-8 py-2 text-white text-sm font-semibold rounded-lg shadow-md transition transform hover:scale-105"
                            style="background-color: #52B74A;">
                            Tambah Obat
                        </a>
                    </div>
                                    ...
                                    <tr class="border-b border-gray-200">
                                        ...
                                        <td class="p-3 flex justify-center items-center space-x-2">
                                            ...
                                            <form action="{{ route('obat.destroy', $obat) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="px-3 py-1 bg-red-500 text-black rounded-lg text-sm">
