      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
          <li class="mt-0.5 w-full">
            <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="{{route('home')}}" style="color: #82534B;">
          ...
          <li class="mt-0.5 w-full">
            <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="{{ route('profil')}}" style="color: #82534B;">
                <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                    <img src="{{ asset('assets/icon/user.svg') }}" alt="Icon" class="h-6 w-6">
                </div>
              <span class="ml-1 text-base duration-300 opacity-100 pointer-events-none ease font-semibold" style="color: #82534B;">Profil</span>
            </a>
          </li>

          <li class="mt-0.5 w-full">
            <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="{{route('riwayat')}}" style="color: #82534B;">
                <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                    <img src="{{ asset('assets/icon/file.svg') }}" alt="Icon" class="h-6 w-6">
                </div>
              <span class="ml-1 text-base duration-300 opacity-100 pointer-events-none ease font-semibold" style="color: #82534B;">Riwayat Pemeriksaan</span>
            </a>
          </li>
              ...
              <div class="flex-1 p-3">
                <div class="flex-1 p-5">
                  ...
                  <div class="flex flex-col gap-2 w-1/5">
                    <a href="{{ route('pendaftaran.form')}}" class="mb-2 w-32 px-6 py-2 text-white text-sm font-semibold item-center rounded-lg shadow-md transition transform hover:scale-105 justify-center items-center" style="background-color: #709972;">
                        Daftar Antrian
                    </a>
                    </div>
              </div>
          ...
          <div class="w-full max-w-2xl mx-auto">
            ...
            bg-[#F3F6F4] shadow-sm rounded-2xl p-4 hover:shadow-2xl transition" style="background: #F3F6F4 !important;">
                  ...
                  <div class="flex flex-col items-center w-1/3">
                    <!-- Card 1 -->
                    <div class="flex flex-col items-center justify-center shadow-sm p-6 ml-12 rounded-lg bg-white text-black w-full mb-4">
                    ...
                    <!-- Card 2 -->
                    <div class="flex flex-col items-center justify-center shadow-sm p-6 ml-12 rounded-lg bg-white text-black w-full">
                  ...
                  <div class="w-2/3 flex flex-col p-4 space-y-4 items-center">
                      <!-- Keterangan Dokter -->
                      <img src="{{ asset('assets/image/antrian.webp') }}" alt="Nomor Antrian" class=" object-contain -z-20">



                      <!-- Tombol -->
                      <div class="flex flex-col gap-2">
                        <a href="{{ route('antrian')}}" class="mb-2 w-32 px-6 py-2 text-white text-sm font-semibold rounded-lg shadow-md transition transform hover:scale-110" style="background-color: #709972;">
                            Lihat Semua Antrian
                        </a>
                    </div>
