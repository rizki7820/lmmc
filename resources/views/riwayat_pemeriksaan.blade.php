      ...
      <div class="w-full px-6 p-4 mx-auto">
        ...
        <div class="w-full max-w-2xl mx-auto">
            <div class="relative flex flex-col bg-white shadow-lg rounded-2xl p-6 hover:shadow-2xl transition">
                <!-- Judul -->
                <h1 class="text-xl font-bold mb-8 text-center" style="color: #82534B; font-size: 24px;">DATA PEMERIKSAAN AWAL</h1>
                <h1 class="text-xl font-bold mb-4 text-center" style="color: #82534B; font-size: 16px;">Terakhir pemeriksaan : </h1>
                            ...
                            <tbody>
                                    @foreach ($pendaftarans as $index => $pendaftaran)
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <td class="p-3 border-r border-gray-300" id="tanggalBooking" data-tanggal="{{ $pendaftaran->tanggal_booking }}"></td>
                                            ...
                                            <td class="p-3 border-r border-gray-300">{{ $pendaftaran->dokter->nama_dokter }}</td>
                                            <td class="p-3 text-green-500 border-r border-gray-300">
                                                {{ $pendaftaran->status ?? 'Menunggu' }}
                                            </td>
                                            <td class="p-3 text-green-500 border-r border-gray-300">
                                               <center>
                                                <a href="" ><img src="{{ asset('assets/icon/file.svg') }}" alt="Icon" class="h-6 w-6">
