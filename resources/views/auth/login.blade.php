        ...
        <div class="w-full max-w-md bg-white rounded-lg p-8 flex flex-col justify-center h-[500px] mx-auto">
            ...
            <form action="{{ route('login') }}" method="POST" class="flex flex-col gap-4">
                ...
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center bg-gray-300 px-3 rounded-l-lg">
                        <img src="assets/image/user.svg" alt="Username Icon" class="w-5 h-5">
                    </span>
                ...
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center bg-gray-300 px-3 rounded-l-lg">
                        <img src="assets/image/password.svg" alt="Password Icon" class="w-5 h-5">
                    </span>
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-gray-600">
                    Belum punya akun? <a href="{{route('register')}}" class="text-[#709972] font-bold hover:underline">Daftar</a>
                </p>
            </div>
        </div>
    </div>
